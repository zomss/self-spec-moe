...
def set_forward_context(
    ...
    # Merge caller-supplied additional_kwargs (e.g. the self-spec local-routing
    # signal set by the draft forward) with platform-supplied context.
    if additional_kwargs:
        platform_kwargs = {**platform_kwargs, **additional_kwargs}
