...
MLA_MODEL="deepseek-ai/DeepSeek-V2-Lite"; MLA_DRAFT="$HOME/ckpts/DeepSeek-V2-Lite-W8A16-INT8-chan"
MOE_MODEL="Qwen/Qwen3-30B-A3B"; MOE_DRAFT="$HOME/ckpts/Qwen3-30B-A3B-W4A16-INT4-sym"
