...
| vocab restriction | vres16k / vres32k | **.9948** / .9957 | **ALIVE and immediately map-relevant** (see below) |
...
**2. vres16k is nearly free beta AND large composed R.** The W4 checkpoint
