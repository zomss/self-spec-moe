...
want spsdvres && run spsdvres spec 6 VLLM_SELF_SPEC_DRAFT_FULLCG=1 VLLM_SELF_SPEC_DRAFT_STEP0_FULL_CG=1 VLLM_SELF_SPEC_CPU_ORCH=1 W7_ASYNC_SCHED=1 VLLM_SELF_SPEC_SHARED_KV_STEP0_DECODE=1 VLLM_SELF_SPEC_DRAFT_VOCAB_KEEP=/data/smcho/self-spec-moe/research/85_exec_selector/data/vres_keep16k.pt
