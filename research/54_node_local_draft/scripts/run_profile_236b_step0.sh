...
W7_MAX_MODEL_LEN=1024 W7_CG_SIZES=8,16,32,64,128 \
W7_MAX_NUM_BATCHED=2048 W7_TAG=prof236b W7_MASTER_PORT=13450 \
VLLM_SELF_SPEC_PROFILE=1 VLLM_SELF_SPEC_PROFILE_OUT=${PROFOUT:-$PHASE/data/profile236b} \
VLLM_SELF_SPEC_LOG_A2A_COUNTS=1 \
VLLM_SELF_SPEC_DRAFT_STEP0_FULL_CG=${STEP0CG:-0} W7_STEP0_CG_EXTRA_SIZES=${EXTRA_SIZES:-} W7_GPU_MEM=${GPU_MEM_OVR:-0.90} W7_STEP0_FORCE_PW=${FORCEPW:-0}"
